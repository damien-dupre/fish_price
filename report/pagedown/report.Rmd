---
title: "Analysis and Forecast of Fish Trade Import and Export in Norway"
author:  |
    [![Logo](https://www.dcu.ie/sites/default/files/marketing/images/dcu_logo_stacked_slate_yellow.png)](https://www.dcu.ie)
...
output:
  pagedown::html_paged:
    ...
    .test: true
subtitle: 'A time feature approach using Glmnet and Prophet'
...
```{r}
# data -------------------------------------------------------------------------
data_raw <- "data/norway_horse_mackerel_exports_raw.csv" %>% read_clean()
